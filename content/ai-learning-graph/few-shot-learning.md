...
Language models are pre-trained on vast amounts of text and develop strong pattern-matching abilities.
A few examples activate the relevant "program" in the model's learned distribution — it recognizes the task format and generalizes.
